...
def Node.tokenize : Node → String := fun
  | .str s => s!"node_str_{s}"
  | .nat n => s!"node_nat_{n}"
  | .name n => s!"node_name_{n}"
  | .level => "node_level"
  | .levelZero => "node_levelZero"
  | .levelSucc => "node_levelSucc"
  | .levelMax => "node_levelMax"
  | .levelIMax => "node_levelIMax"
  | .levelParam => "node_levelParam"
  | .levelMVar => "node_levelMVar"
  | .proof => "node_proof"
  | .bvar => "node_bvar"
  | .mvar => "node_mvar"
  | .fvar => "node_fvar"
  | .sort => "node_sort"
  | .const nm => s!"node_const_{nm}"
  | .app => "node_app"
  | .lam .default => "node_lam_default"
  | .lam .implicit => "node_lam_implicit"
  | .lam .strictImplicit => "node_lam_strictImplicit"
  | .lam .instImplicit => "node_lam_instImplicit"
  | .forallE .default => "node_forallE_default"
  | .forallE .implicit => "node_forallE_implicit"
  | .forallE .strictImplicit => "node_forallE_strictImplicit"
  | .forallE .instImplicit => "node_forallE_instImplicit"
  | .letE => "node_letE"
  | .proj nm idx => s!"node_proj_{nm}_{idx}"
  | .goalState => "node_goalState"
...
def Edge.tokenize : Edge → String := fun
  | .levelSuccArg => "edge_levelSuccArg"
  | .levelMaxArgL => "edge_levelMaxArgL"
  | .levelMaxArgR => "edge_levelMaxArgR"
  | .levelIMaxArgL => "edge_levelIMaxArgL"
  | .levelIMaxArgR => "edge_levelIMaxArgR"
  | .fvarType => "edge_fvarType"
  | .fvarVal => "edge_fvarVal"
  | .mvarType => "edge_mvarType"
  | .mvarVal => "edge_mvarVal"
  | .proofType => "edge_proofType"
  | .sortLevel => "edge_sortLevel"
  | .constLevelArg n => s!"edge_sortLevelArg_{n}"
  | .appFn => "edge_appFn"
  | .appArg n => s!"edge_appArg_{n}"
  | .lamVar => "edge_lamVar"
  | .lamBody => "edge_lamBody"
  | .forallEVar => "edge_forallEVar"
  | .forallEBody => "edge_forallEBody"
  | .letEVar => "edge_letEVar"
  | .letEBody => "edge_letEBody"
  | .projStruct => "edge_projStruct"
  | .localDecl => "edge_localDecl"
  | .goal idx => s!"edge_goal_{idx}"
